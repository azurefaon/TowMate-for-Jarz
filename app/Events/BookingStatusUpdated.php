...
class BookingStatusUpdated implements ShouldBroadcastNow
{
    ...
    public function broadcastWith(): array
    {
        ...
        return [
            ...
            'is_returned' => ! is_null($this->booking->returned_at)
                && in_array($this->booking->status, ['confirmed', 'accepted', 'assigned']),
            'return_reason' => $this->booking->return_reason,
            ...
            'unit_name' => $this->booking->unit->name ?? ($this->booking->unit->plate_number ?? 'Unit'),
