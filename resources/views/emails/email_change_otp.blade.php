...
<title>TowMate Email Change Code</title>
</head>
      ...
      <table width="480" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 2px 16px rgba(0,0,0,0.06);">
        ...
        <tr>
          <td style="padding:36px 36px 28px;">
            <p style="margin:0 0 8px;font-size:22px;font-weight:600;color:#1a1a1a;">Confirm your new email</p>
            <p style="margin:0 0 28px;font-size:14px;color:#757575;line-height:1.6;">
              Use the code below to confirm this email address for your TowMate account. This code expires in <strong>10 minutes</strong>.
            </p>
            <!-- OTP block -->
            ...
            <p style="margin:0;font-size:13px;color:#9e9e9e;line-height:1.6;">
              If you didn't request this, you can safely ignore this email — your account email will not change without this code.
            </p>
          </td>
        </tr>
        <!-- Footer -->
