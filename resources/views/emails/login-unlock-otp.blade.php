...
<title>Your TowMate verification code</title>
</head>
  ...
  <tr>
    <td align="center">
      <table width="480" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 2px 16px rgba(0,0,0,0.06);">
        <!-- Header -->
        <tr>
          <td style="background:#171717;padding:28px 36px;text-align:center;">
            <span style="font-size:28px;font-weight:700;color:#ffffff;">Tow</span><span style="font-size:28px;font-weight:700;color:#facc15;">Mate</span>
          </td>
        </tr>
        <!-- Body -->
        <tr>
          <td style="padding:36px 36px 28px;">
            <p style="margin:0 0 8px;font-size:22px;font-weight:600;color:#171717;">Recover access</p>
            <p style="margin:0 0 20px;font-size:14px;color:#757575;line-height:1.6;">
              We received a request to recover sign-in access to your TowMate account.
            </p>
            ...
            <div style="background:#f5f5f5;border-radius:12px;padding:24px;text-align:center;margin-bottom:20px;">
              <span style="font-size:42px;font-weight:700;letter-spacing:12px;color:#171717;">{{ $otp }}</span>
            </div>
