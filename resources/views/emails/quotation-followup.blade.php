                ...
                <table width="100%" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td style="padding:24px 28px 0;">
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="background:#fafafa;border:1px solid #e4e4e7;border-radius:10px;padding:14px 18px;">
                                        <p style="margin:0 0 4px;font-size:14px;font-weight:bold;color:#18181b;">You
                                            have a pending towing quotation.</p>
                                        <p style="margin:0;font-size:13px;color:#71717a;line-height:1.5;">This is a
                                            friendly reminder that we're still waiting for your response. Your
                                            quotation will expire soon.</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td style="padding:20px 28px 0;">
                            <p style="margin:0 0 10px;font-size:15px;color:#3f3f46;line-height:1.5;">
                                Hi <strong
                                    style="color:#18181b;">{{ $quotation->customer->full_name ?? $quotation->customer->name }}</strong>,
                                here's your quotation for review.
                            </p>
