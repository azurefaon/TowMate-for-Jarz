                    ...
                    <tr>
                        <td style="padding:24px 28px 0;">
                            <p style="margin:0 0 10px;font-size:15px;color:#3f3f46;line-height:1.5;">
                                ...
                                the price for your quotation has been revised.
                            </p>
                            <p
                                ...
                                <tr>
                                    <td style="background:#fffbeb;border-radius:10px;padding:14px 18px;">
                                        ...
                                        <p style="margin:0;font-size:13px;color:#b45309;line-height:1.5;">
                                            Your quotation has a revised price — please review the updated
                                            breakdown below.
                                        </p>
                                    </td>
                                </tr>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="margin-top:12px;">
                                <tr>
                                    ...
                                    <td align="right" style="font-size:12.5px;color:#71717a;">Distance: <strong
                                            style="color:#18181b;">{{ number_format($priceBreakdown['distance_km'], 2) }}
                                            km</strong></td>
                                </tr>
                            </table>
                        </td>
