...
@section('title', 'Users')
@section('subtitle', 'Manage staff accounts and account access.')
    ...
    <div class="user-management-page">
        ...
        <div class="table-card">
            <div class="table-toolbar">
                <a href="{{ route('system-admin.users.archived') }}" class="btn-table-action secondary">
                    <span class="btn-icon">
                    ...
                    @if (($stats['archived'] ?? 0) > 0)
                        <span class="btn-table-action-count">{{ $stats['archived'] }}</span>
                    @endif
                </a>
                <a href="{{ route('system-admin.users.deleted') }}" class="btn-table-action secondary">
                    <span class="btn-icon">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linejoin="round">
                    ...
                    @if (($stats['deleted'] ?? 0) > 0)
                        <span class="btn-table-action-count">{{ $stats['deleted'] }}</span>
                    @endif
                </a>
                <a href="{{ route('system-admin.users.create') }}" class="btn-table-action primary">
                    <span class="btn-icon">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linejoin="round">
            ...
            <div class="table-header">
                <form method="GET" class="filters" id="usersFilterForm">
                    ...
                    <a href="{{ route('system-admin.users.index') }}" class="btn-reset">Reset</a>
                </form>
            </div>

            <div id="usersTableContainer">
                @include('system-admin.users.partials.table')
            </div>
        </div>
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const indexUrl = "{{ route('system-admin.users.index') }}";
