...
@push('styles')
    <link rel="stylesheet" href="{{ asset('admin/css/system-admin-user-create.css') }}?v={{ filemtime(public_path('admin/css/system-admin-user-create.css')) }}">
    <style>
        .phone-input-wrap {
            display: flex;
            align-items: center;
        ...
        <div class="form-wrapper" style="margin-top:0;">
            <div class="form-card">
                ...
                <div id="formSection" @if (!$showFormOnLoad) hidden @endif>
                    ...
                    <form method="POST"
                        action="{{ $isEdit ? route('system-admin.users.update', $user->id) : route('system-admin.users.store') }}"
                ...
                form.addEventListener('submit', async (e) => {
                    ...
                    try {
                        ...
                        if (res.ok && data.success) {
                            ...
                            window.location.href = '{{ route('system-admin.users.index') }}';
                        } else if (data.errors) {
