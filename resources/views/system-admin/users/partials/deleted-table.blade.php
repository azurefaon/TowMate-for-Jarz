            ...
            @forelse ($deletedUsers as $user)
                ...
                <tr>
                    ...
                    <td data-label="Status">
                        <span class="ua-status-text ua-status-pending">Pending Deletion</span>
                    </td>
                    ...
                    <td data-label="Actions" class="u-actions-col">
                        <div class="u-menu">
                            ...
                            <div class="u-menu-dropdown" role="menu">
                                <form method="POST" action="{{ route('system-admin.users.restore-from-deleted', $user->id) }}" class="u-menu-form">
                                    @csrf
                                    @method('PATCH')
                                ...
                                <form method="POST" action="{{ route('system-admin.users.purge-now', $user->id) }}"
                                    class="u-menu-form js-confirm-delete"
...
<div class="ua-table-footer">
    {{ $deletedUsers->appends(request()->query())->links('vendor.pagination.owner-standard') }}
</div>
