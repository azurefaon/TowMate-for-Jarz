    ...
    <div class="login-wrapper">
        <section class="login-left">
            ...
            <div class="brand-section">
                ...
                @if(file_exists(public_path(‘downloads/towmate.apk’)))
                <a href="{{ asset(‘downloads/towmate.apk’) }}" download="TowMate.apk"
                    style="display:inline-flex;align-items:center;gap:8px;margin-top:18px;padding:11px 22px;background:#f59e0b;color:#0f172a;font-family:’Inter’,sans-serif;font-size:0.875rem;font-weight:700;text-decoration:none;border-radius:999px;">
