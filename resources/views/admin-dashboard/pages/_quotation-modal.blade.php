...
<div id="quotationModal"
    ...
    <div class="modal-card"
        ...
        <!-- Modal Header -->
        <div style="padding: 20px 24px 16px; border-bottom: 1px solid #f1f5f9; display: flex; justify-content: space-between; align-items: center; position: sticky; top: 0; background: #fff; border-radius: 16px 16px 0 0; z-index: 10;">
            <div>
                <h3 style="margin: 0; font-size: 1.1rem; font-weight: 700; color: #0f172a;" id="quotationModalTitle">Quotation Details</h3>
                <p style="margin: 4px 0 0; font-size: 0.8rem; color: #94a3b8;" id="quotationModalSubtitle">Review and manage this quotation</p>
            </div>
        ...
        <div style="padding: 20px 24px; flex: 1; overflow-y: auto;">
            ...
            <!-- Quotation # Badge + Customer Info -->
            <div style="margin-bottom: 20px;">
                <!-- Quotation # highlighted pill -->
                <div style="display: inline-flex; align-items: center; gap: 8px; background: #eff6ff; border: 1px solid #bfdbfe; border-radius: 8px; padding: 7px 14px; margin-bottom: 12px;">
                    <span style="font-size: 0.72rem; font-weight: 700; color: #3b82f6; text-transform: uppercase; letter-spacing: 0.07em;">Quotation #</span>
                    <span style="font-size: 0.95rem; font-weight: 800; color: #1d4ed8; font-family: monospace; letter-spacing: 0.03em;" id="qmQuotationNumber">—</span>
                </div>
                ...
                <div style="background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 10px; padding: 13px 18px;">
                    <div style="font-size: 0.7rem; color: #94a3b8; font-weight: 600; text-transform: uppercase; letter-spacing: 0.06em; margin-bottom: 4px;">Customer</div>
                    <div style="font-size: 0.95rem; font-weight: 700; color: #0f172a; margin-bottom: 3px;" id="qmCustomerName">—</div>
            ...
            <div style="background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 10px; padding: 16px; margin-bottom: 20px;">
                <div style="font-size: 0.75rem; font-weight: 700; color: #64748b; text-transform: uppercase; letter-spacing: 0.05em; margin-bottom: 12px;">Route</div>
                <div style="display: flex; align-items: flex-start; gap: 10px; margin-bottom: 10px;">
                    <div style="flex-shrink: 0; width: 24px; height: 24px; border-radius: 50%; background: #22c55e; display: flex; align-items: center; justify-content: center; font-weight: 800; font-size: 0.72rem; color: #fff; margin-top: 1px;">A</div>
                    <div>
                ...
                <div style="margin-left: 12px; width: 1px; height: 10px; background: #e2e8f0; margin-bottom: 10px;"></div>
                <div style="display: flex; align-items: flex-start; gap: 10px;">
                    <div style="flex-shrink: 0; width: 24px; height: 24px; border-radius: 50%; background: #ef4444; display: flex; align-items: center; justify-content: center; font-weight: 800; font-size: 0.72rem; color: #fff; margin-top: 1px;">B</div>
                    <div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px; margin-top: 14px; padding-top: 14px; border-top: 1px solid #e2e8f0;">
                    <div>
            ...
            <!-- Vehicle Photos -->
            <div id="qmImageGallery" style="background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 10px; padding: 16px; margin-bottom: 20px; display: none;">
                <div style="font-size: 0.75rem; font-weight: 700; color: #64748b; text-transform: uppercase; letter-spacing: 0.05em; margin-bottom: 12px;">Vehicle Photos</div>
                <div id="qmImageGrid" style="display: flex; gap: 8px; flex-wrap: wrap;"></div>
                <p id="qmNoImages" style="color: #94a3b8; font-size: 0.85rem; margin: 0; display: none;">No photos uploaded.</p>
            </div>
            ...
            <div style="border: 1px solid #e2e8f0; border-radius: 10px; overflow: hidden; margin-bottom: 20px;">
                <div style="padding: 12px 16px; background: #f8fafc; border-bottom: 1px solid #e2e8f0;">
                    <span style="font-size: 0.75rem; font-weight: 700; color: #64748b; text-transform: uppercase; letter-spacing: 0.05em;">Price Breakdown</span>
                </div>
                <div style="padding: 16px; display: grid; gap: 10px;">
                    ...
                    <div id="qmDistanceFeeRow" style="display: flex; justify-content: space-between; font-size: 0.88rem; color: #475569;">
                        <span id="qmDistanceFeeLabel">Distance Fee</span>
                        <span style="font-weight: 600;" id="qmDistanceFee">₱0.00</span>
                    </div>
                    <!-- Excess breakdown (shown only when distance > 4km) -->
                    <div id="qmExcessFeeRow" style="display: none; margin-left: 12px; padding-left: 12px; border-left: 2px solid #e2e8f0; gap: 6px; flex-direction: column;">
                        <div style="display: flex; justify-content: space-between; font-size: 0.8rem; color: #64748b;">
                            <span>First 4 km × <span id="qmPerKmRate">₱0</span>/km</span>
                            <span id="qmFirst4KmFee">₱0.00</span>
                        </div>
                        <div style="display: flex; justify-content: space-between; font-size: 0.8rem; color: #64748b;">
                            <span><span id="qmExcessKm">0</span> km excess × ₱200/km</span>
                            <span id="qmExcessKmFee">₱0.00</span>
                        </div>
                    </div>
                    <div id="qmOtherFeesRow" style="display: none; flex-direction: row; justify-content: space-between; font-size: 0.88rem; color: #475569;">
                        <span>Additional Fees</span>
                        <span style="font-weight: 600;" id="qmOtherFees">₱0.00</span>
                    </div>
                    <div style="border-top: 1px solid #e2e8f0; padding-top: 12px; display: flex; justify-content: space-between; align-items: baseline;">
                        <span style="font-size: 0.95rem; font-weight: 700; color: #0f172a;">Total</span>
                        <span style="font-size: 1.2rem; font-weight: 800; color: #0f172a;" id="qmTotalAmount">₱0.00</span>
                    </div>
                </div>
            </div>
            ...
            <div style="border: 1px solid #e2e8f0; border-radius: 10px; overflow: hidden; margin-bottom: 20px;">
                <div style="padding: 12px 16px; background: #f8fafc; border-bottom: 1px solid #e2e8f0; display: flex; align-items: center; justify-content: space-between;">
                    <span style="font-size: 0.75rem; font-weight: 700; color: #64748b; text-transform: uppercase; letter-spacing: 0.05em;">Adjust Price</span>
                    <span style="font-size: 0.72rem; color: #94a3b8;">Optional — enter 0 to keep base price</span>
                </div>
                <div style="padding: 16px; display: grid; gap: 14px;">
                    <div>
                        <label style="display: block; font-size: 0.8rem; font-weight: 600; color: #374151; margin-bottom: 6px;">Additional Fees (₱)</label>
                        <input type="number" id="qmOtherFeesInput" step="0.01" min="0" value="0.00"
                            ...
                            onfocusin="this.style.borderColor='#6366f1'" onfocusout="this.style.borderColor='#d1d5db'">
                    </div>
                    <div style="background: #f1f5f9; border-radius: 8px; padding: 12px 14px; display: flex; justify-content: space-between; align-items: center;">
                        <span style="font-size: 0.85rem; color: #475569; font-weight: 500;">New Total</span>
                        <span style="font-size: 1.15rem; font-weight: 800; color: #0f172a;" id="qmCalculatedPrice">₱0.00</span>
                    </div>
                    <div>
                        <label style="display: block; font-size: 0.8rem; font-weight: 600; color: #374151; margin-bottom: 6px;">Note <span style="font-weight: 400; color: #94a3b8;">(optional)</span></label>
            ...
            <div id="qmCounterOfferSection" style="display: none; border: 1px solid #fde68a; border-radius: 10px; overflow: hidden; margin-bottom: 20px;">
                <div style="padding: 12px 16px; background: #fffbeb; border-bottom: 1px solid #fde68a;">
                    <span style="font-size: 0.75rem; font-weight: 700; color: #92400e; text-transform: uppercase; letter-spacing: 0.05em;">Customer Counter Offer</span>
                </div>
                <div style="padding: 14px 16px; display: grid; grid-template-columns: auto 1fr; gap: 8px 12px; font-size: 0.88rem; align-items: start;">
        ...
        <div style="padding: 16px 24px; border-top: 1px solid #f1f5f9; display: flex; gap: 8px; justify-content: flex-end; background: #fff; border-radius: 0 0 16px 16px;">
            <button type="button" onclick="closeQuotationModal()"
...
<script>
            ...
            .then(data => {
                ...
                if (imagePaths.length === 0) {
                    ...
                    imagePaths.forEach(function(path) {
                        ...
                        img.style.cssText = 'width:100px;height:78px;object-fit:cover;border-radius:8px;cursor:pointer;border:1px solid #e2e8f0;transition:opacity 0.15s;';
                ...
                document.getElementById('qmBasePrice').textContent = fmt(q.base_price || 0);
                document.getElementById('qmDistanceFee').textContent = fmt(distanceFee);

                const customerPrice = parseFloat(q.subtotal || 0);
                document.getElementById('qmTotalAmount').textContent = fmt(customerPrice);
                document.getElementById('qmCalculatedPrice').textContent = fmt(customerPrice);
                ...
                if (q.has_excess) {
                    ...
                    document.getElementById('qmDistanceFeeLabel').textContent = `Distance (${distanceKm.toFixed(2)} km)`;
                    document.getElementById('qmExcessFeeRow').style.display = 'flex';
                    document.getElementById('qmPerKmRate').textContent = fmt(perKmRate);
                    document.getElementById('qmFirst4KmFee').textContent = fmt(first4KmFee);
                    document.getElementById('qmExcessKm').textContent = excessKm.toFixed(2);
                    document.getElementById('qmExcessKmFee').textContent = fmt(excessFee);
                } else {
                    document.getElementById('qmDistanceFeeLabel').textContent = `Distance (${distanceKm.toFixed(2)} km × ₱${perKmRate.toFixed(2)}/km)`;
                    document.getElementById('qmExcessFeeRow').style.display = 'none';
                }

                // Real-time total recalc
                const otherFeesInput = document.getElementById('qmOtherFeesInput');
                otherFeesInput.oninput = function() {
                    const base = window.qmCustomerPrice || 0;
                    const fees = parseFloat(this.value || 0);
                    const newTotal = base + fees;
    ...
    function updateQuotationPrice() {
        ...
        const newPrice = (window.qmCustomerPrice || 0) + otherFees;
        const note = document.getElementById('qmPriceNote').value;

        if (newPrice < 0) { showModalMessage('Price cannot be negative', 'error'); return; }
        ...
        fetch(`/admin-dashboard/quotations/${currentQuotationId}/update-price`, {
                ...
                body: JSON.stringify({ new_price: newPrice, additional_fee: otherFees, note: note })
            })
            .then(r => r.json())
            .then(data => {
                if (data.success) {
    ...
    function sendQuotationToCustomer(quotationId) {
        // quotationId may come from table button (before modal open) or from modal button
            ...
            .then(data => {
                if (data.success) {
                    ...
                    if (document.getElementById('quotationModal').style.display === 'flex') {
                        ...
                        setTimeout(() => { closeQuotationModal(); location.reload(); }, 2000);
                    } else {
    ...
    function showModalMessage(message, type) {
        ...
        div.id = 'qmMessage';
        div.style.cssText = `padding:10px 14px; border-radius:8px; margin-bottom:14px; font-size:0.875rem; font-weight:600; background:${c.bg}; color:${c.color}; border:1px solid ${c.border}; display:flex; align-items:center; gap:8px;`;
