...
<div class="quotation-expiry-banner quotation-expiry-banner--{{ $urgencyClass }}" 
     data-expires-at="{{ $booking->quotation_expires_at }}"
            ...
            @else
                <div class="quotation-expiry-banner__countdown">
                    <div class="quotation-expiry-banner__time-unit">
                        <span class="quotation-expiry-banner__time-value" data-hours>{{ str_pad($hours, 2, '0', STR_PAD_LEFT) }}</span>
                        <span class="quotation-expiry-banner__time-label">Hours</span>
                    </div>
                    <span class="quotation-expiry-banner__time-separator">:</span>
                    <div class="quotation-expiry-banner__time-unit">
                        <span class="quotation-expiry-banner__time-value" data-minutes>{{ str_pad($minutes, 2, '0', STR_PAD_LEFT) }}</span>
...
(function() {
    ...
    function updateTimer() {
        ...
        banner.classList.remove('quotation-expiry-banner--info', 'quotation-expiry-banner--warning', 'quotation-expiry-banner--urgent');
